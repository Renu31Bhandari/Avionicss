...
/*$(document).ready(function() {
    ...
    var raw = document.querySelector(".rawTxt").style.display == "block";
    var org = document.querySelector(".originalDoc").style.display == "block";

    if (raw && org) {

        document.querySelector(".tempTest").style.display == "block";
    }

     else {
        document.querySelector(".tempTest").style.display == "none");
     }
     
});*/

/*var raw = document.querySelector(".rawTxt");
var org = document.querySelector(".originalDoc");

if ((raw.style.display == "block" || org.style.display == "none") && (raw.style.display == "none" || org.style.display == "block")) {
  document.querySelector(".tempTest").style.display == "block";
}
...
/*$(document).ready(function() {
    ...
    if(($raw=="block" || $org=="none") && ($raw=="none" || $org=="block") {
        $(".tempTest").css("display","block");
    }
